...
<p>State</p>
<input name="state" type="text" class="inputvalues" placeholder="Type your address" required /><br>
<p>Pincode</p>
<input name="pincode" type="text" class="inputvalues" placeholder="Type your pincodes" required /><br>
<p>Gender</p>
<input name="gender" type=radio required>M</input>
<input name="gender" type=radio required>F</input>
<p>E-Mail</p>
<input name="email" type='email' placeholder="Type youremail address" required /><br>
<p>Contact Number</p>
...
mysqli_select_db($con,"emergency");
 ...
 if(isset($_POST['submit']))
 {
	 ...
	 {
		 echo '<script type="text/javascript"> alert("phone numner already exist") </script> ' ;
	 }
	 else
	 { 
